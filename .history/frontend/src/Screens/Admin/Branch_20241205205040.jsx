...
const Branch = () => {
  ...
  const deleteBranchHandler = (id) => {
    const alert = prompt("Bạn có chắc chắn không? Nhập XÁC NHẬN để tiếp tục");
    if (alert === "XÁC NHẬN") {
      toast.loading("Xóa chi nhánh");
      const headers = {
        "Content-Type": "application/json",
      };
      axios
