  ...
  return (
    <div className="w-full mx-auto mt-10 flex justify-center items-start flex-col mb-10">
      <div className="flex justify-between items-center w-full">
        <Heading title={`Cập nhật thời khóa biểu`} />
      </div>
      <div className="w-full flex justify-evenly items-center mt-12">
        <div className="w-1/2 flex flex-col justify-center items-center">
          <p className="mb-4 text-xl font-medium">Thêm thời gian biểu</p>
          <select
            id="branch"
          ...
          >
            <option defaultValue>-- Chọn chi nhánh --</option>
            {branch &&
              branch.map((branch) => {
                return (
          ...
          <select
            ...
            className="px-2 bg-blue-50 py-3 rounded-sm text-base w-[80%] accent-blue-700 mt-4"
          >
            <option defaultValue>--Lựa chọn học kỳ--</option>
            <option value="1">Học kỳ 1</option>
            <option value="2">Học kỳ 2</option>
            <option value="3">Học kỳ </option>
            <option value="4">Học kỳ 1</option>
            <option value="5">Học kỳ 1</option>
            <option value="6">Học kỳ 1</option>
            <option value="7">Học kỳ 1</option>
            <option value="8">Học kỳ 1</option>
          </select>
          {!addselected.link && (
            <label
              htmlFor="upload"
