        ...
        <>
          <div className="mt-10 w-full flex justify-evenly items-center gap-x-6">
            ...
            <div className="w-full">
              ...
              >
                <option defaultValue>--Lựa Chọn--</option>
                <option value="1">10 điểm</option>
                <option value="2">20 điểm</option>
                <option value="3">30 điểm</option>
                <option value="4">40 điểm</option>
                <option value="5">50 điểm</option>
                <option value="6">60 điểm</option>
                <option value="7">70 điểm</option>
                <option value="8">80 điểm</option>
              </select>
            </div>
            <div className="w-full">
              <label htmlFor="semester" className="leading-7 text-base ">
